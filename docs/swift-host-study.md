...
| **Scrape** | `oauth_usage`, `codex_usage`, `cursor_usage`, `github_actions`, `vercel_builds`, `supabase_usage`, `plausible_usage`, `local_servers`, `git_activity`, `detect_sources` | ~3,290 |
